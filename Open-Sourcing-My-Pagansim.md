...
## Open Source
So how can we do that?  How can we present an honest, context-rich, multidimensional, multifaceted, systemic view of a Pagan tradition as it changes in real time?  My answer: open source.

### Open Source Ethos
The open source software movement's values center around principles of open collaboration and transparency[^ossm].  This movement's ethics have informed additional movements around free access to both computer code and cultural content, in the Free Software Movement and the Free Culture Movement.[^fsm][^fcm]  As a result, it was somewhat inevitable for religions to get onboard, and we now have a growing Open Source Religions movement. Pagansim is well-represented in the open source religions space, including Wicca and Discordianism (and notably, Discordianism is also a component of Faerie Faith training).[^osr][^osw]

Extending the metaphor and language of open source software development a little further, we can see how these ideas can help answer the four questions I posed above:
* How do we talk to potential students, and the world at large, about our history?  If our history faced the same challenges of misappropriation and misrepresentation as the history of Wicca and Gerald Gardner, how were we to grapple with and communicate that fact?
    * With an ethic of transparency.  I intend to make the origins and evolution of Faerie Faith visible to the world, and when asked, place historical events in a context.
* In regards to Huna, how could I teach students a lie, especially one that is actively harming a living culture?
    * I won't -- I will substitute it with the Internal Family Systems model as a way to talk about students' lived experience.
* In regards to Native American traditions and shamanism, again, I read accounts of how these outside sources were actively causing harm to living, marginalized communities. And again, I had to grapple with how I personally had been positively impacted by some of the readings and exercises in these works during my own training.  And yet again, how was I supposed to present this content in a way that honored the strong ethical foundation that my teachers had passed on to me?
    * With transparency.  For Pat and Linda, Huna worked -- that was the ultimate test for inclusion.  I honor the fact that they used what they could find to help students experience a new relationship with Nature. I will not disparage the past inclusion of Huna in Faerie Faith, nor will I disparage other teachers that continue to use it (although I may suggest some "additional readings" to help place Huna into context).  Since a diversity of thought, experience, and practice will keep Faerie Faith alive, I'm fine with others using Huna while I use IFS.
* How can Faerie Faith continue to be a welcoming space for confronting the difficult challenges of personal growth and transformation, regardless of gender, identify, or label?  How can we find a new place of balance as the global conversation continues to shift?
    * This is a question that I can not answer alone.  I think it will naturally be answered as new students come to Faerie Faith and shape it by raising questions, concerns, and even objections.  Conversation is a powerful way to shift minds and hearts, and every teacher of the Faerie Faith is also, ultimately, a student.



So my own hope is to open up the source code of Faerie Faith (origins, readings, references, stories, citations, source material, etc.) and to develop additional practices (functionality) to the code.  


I want to honor the source code given to me by my teachers, however this essay is my attempt at "refactoring the code"[^refactoring] to better suit my own needs and the needs of my potential students.

Next, I

This is both a shift in ethos and praxis -- a reorientation toward my practice of my Paganism.  A personal value, but one that I hope will spread with my own practice of it.
